...
public enum Mode implements Serializable {
    ...
    @SerializedName(value = "Alita", alternate = {"Taxi","HailedSharedTaxi"}) ALITA_TAXI(R.drawable.ic_transport_alita, Color.parseColor("#FFD700"), R.drawable.item_marker_alita, "alita"),
